...
const stralingKracht  = 0.032;  //hoe snel de planeet afkoelt naar het omringende (lager = betere warmtebehoud; verdubbeld)
const tempDiffusie    = 0.0025; //hoe snel de temperatuur zich over de buren verdeelt
