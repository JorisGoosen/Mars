...
const ijsTempo      = 0.002;  //fractie water/ijs dat per ronde per Kelvin onder/boven het vriespunt bevriest/dooit (trager)
...
const tempDiffusie    = 0.01;   //hoe snel de temperatuur zich over de buren verdeelt
